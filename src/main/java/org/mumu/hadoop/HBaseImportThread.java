...
//                if(!puts.isEmpty()){
//                	synchronized(this){
//                		logger.info(Thread.currentThread().getName() + " starts to write {} records to table...",puts.size());  
//                		table.put(puts);
                table.flushCommits();
                table.close();
                logger.info(Thread.currentThread().getName() + " wrote {} records to table...",count);
//                	}
//                }
